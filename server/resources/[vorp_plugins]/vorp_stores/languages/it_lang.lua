...
Locales["it_lang"] = {
    ...
    sellmenu = "Menù vendita",
    buymenu = "Menù emporio",
    sellfor = "VENDI PER",
    buyfor = "COMPRA PER",
    youdontsell = "Non hai oggetti da vendere!",
    chooseoption = " Scegli un opzione",
    amount = "QUANTITA'",
    confirm = "Conferma",
    insertamount = "Inserisci una quantità!",
    ...
    am = ":00~q~am to ~o~",
    pm = ":00~q~pm",
    limitSell = "Non compro più così tanto di questo articolo",
    limitBuy = "Sfortunatamente non ne ho più così tanto in magazzino."
}
