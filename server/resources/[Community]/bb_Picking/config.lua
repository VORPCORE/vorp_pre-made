...
Config.collectables = {
    ['rdr_bush_neat_bb_sim'] = { -- prop/item found in game 
        ...
        items = {
            ['consumable_herb_currant'] = 5,
            ['blackberry'] = 3,
            ['blueberry'] = 3,
            ['consumable_herb_wintergreen_berry'] = 3,
            ['consumable_herb_evergreen_huckleberry'] = 3            --Number of items that can be max found
        }
    },
    ['rdr_bush_neat_aa_sim'] = {
        ...
        items = {
            ...
            ['blueberry'] = 3,
            ['consumable_herb_wintergreen_berry'] = 3,
            ['consumable_herb_evergreen_huckleberry'] = 3   --DB of items
        }
    },
    ...
    ['rdr_bush_sumac_aa_sim'] = {
        ...
        items = {
            ['consumable_herb_wintergreen_berry'] = 3,
            ['consumable_herb_evergreen_huckleberry'] = 3  
        }
    },
    ['p_tree_orange_01'] = {
        Label = "Tree",
    ...
    ['s_inv_chanterelles'] = {
        Label = "Chanterelles",
        items = {
            ['consumable_herb_chanterelles'] = 3
        }
    },
    ['s_inv_oregano01dx'] = {
        Label = "Small bush",
        items = {
            ['consumable_herb_vanilla_flower'] = 3,
            ['consumable_herb_indian_tobacco'] = 3,
            ['oregano'] = 3
        }
    },
