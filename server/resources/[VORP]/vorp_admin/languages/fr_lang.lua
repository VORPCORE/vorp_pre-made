...
Locales["fr_lang"] = {
    ...
    banunban_desc              =
    "type = ban/unban<br> StaticID = number NOT server ID <br> Time example 1h,1d,1w,1m,1y permaban 0 <br>DONT USE IF TYPE IS UNBAN",
    whiteunwhite_desc          =
    "type = whitelist/unwhitelist <br> StaicID = number<br> check discord to get his static ID or databse",
    ...
    viewreports_desc           = "view reports from users",
    searchplayer               = "Search Player",
    searchplayer_desc          = "Search Player",
