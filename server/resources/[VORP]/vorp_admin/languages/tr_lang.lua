...
Locales["tr_lang"] = {
    ...
    banunban_desc              =
    "Type = Ban/Unnan <br> StaticID = Sunucu Kimliği Değil <br> Zaman Örnek 1H, 1D, 1W, 1M, 1y Permaban 0 <br> Türü BAĞIMSI İSİYORSA kullanmayın",
    whiteunwhite_desc          =
    "Type = beyaz liste/unblapelist <br> staicid = numara <br> Statik kimliğini veya veritabanını almak için anlaşmazlığı kontrol edin",
