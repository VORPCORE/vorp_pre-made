(function () {
  ...
  MenuData.submit = function (namespace, name, data) {
    if (data == "backup") {
      $.post(
        "http://" + MenuData.ResourceName + "/menu_submit",
        JSON.stringify({
  ...
  MenuData.cancel = function (namespace, name) {
    $.post(
      "http://" + MenuData.ResourceName + "/menu_cancel",
      JSON.stringify({
        _namespace: namespace,
        _name: name,
      })
  ...
  MenuData.change = function (namespace, name, data) {
    $.post(
      "http://" + MenuData.ResourceName + "/menu_change",
      JSON.stringify({
        _namespace: namespace,
        _name: name,
        current: data,
        ...
        switch (data.ak_menubase_control) {
          ...
          case "BACKSPACE": {
            ...
            if (lastmenu != "undefined" && lastmenu != "") {
              ...
              $.post(
                "http://" + MenuData.ResourceName + "/closeui",
                JSON.stringify({})
              );
            }
            break;
          ...
          case "TOP": {
            ...
            if (typeof focused != "undefined") {
              ...
              let elem =
                menu.elements[MenuData.pos[focused.namespace][focused.name]];
